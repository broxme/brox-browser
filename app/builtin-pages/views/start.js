...
const RELEASE_NOTES_URL = 'https://github.com/broxme/brox/releases/tag/1.1.2'
  ...
  return yo`
    <div class="dock-wrapper">
      <div class="dock">
        ...
        <a class="dock-item" href="broxme://history">
          History
        </a>
		<span class="dock-separator">|</span>
        <a class="dock-item" href="broxme://bookmarks">
          Bookmarks
        </a>
		<span class="dock-separator">|</span>
        <a class="dock-item" href="broxme://library">
          Library
        </a>
