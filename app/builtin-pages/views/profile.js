...
async function loadViewedProfile () {
  ...
  try {
    ...
    if (!(viewedProfile && viewedProfile._origin)) {
      ...
      history.replaceState({}, null, 'broxme://profile/' + viewedProfile._origin.slice('dat://'.length))
    } else {
    ...
    <div class="following-view">
      ...
      <div class="following-list">
        ${viewedProfile.follows.map(f => {
          ...
          return yo`
            <a class="following-card" href="broxme://profile/${f.url.slice('dat://'.length)}" title=${name}>
