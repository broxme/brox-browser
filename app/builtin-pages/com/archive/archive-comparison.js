    ...
    if (isLocalSyncPath) {
          ...
          ${target.info.userSettings.localSyncPath
            ? yo`
                <p class="empty-description">
                  The files in <a href="broxme://library/${target.url}" onclick=${gotoHomeView}>${getSafeTitleHTML(target)}</a>
            ...
            : yo`
                <p class="empty-description">
                  All the files in <a href="broxme://library/${target.url}" onclick=${gotoHomeView}>${getSafeTitleHTML(target)}</a> have been published to the network.
                </p>`
          }
      ...
      return yo`
        <div class="empty">
          ...
          <p>
            The files in <a href="broxme://library/${base.url}" target="_blank">${getSafeTitleHTML(base)}</a>
            are in sync with the files in
            <a class="link" href="broxme://library/${target.url}" target="_blank">${getSafeTitleHTML(target)}</a>.
          </p>
