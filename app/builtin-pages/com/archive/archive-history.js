    ...
    return yo`
      <div class="archive-history ${history ? '' : 'loading'}">
        <div class="archive-history-body">
          <div onclick=${onGoto} class="archive-history-item ${includePreview ? '' : 'no-border'}" title="View latest published" href="broxme://library/${baseUrl}+latest${filePath}">
            <span class="fa fa-fw fa-globe-americas"></span>
            View latest published
          </div>
          ${includePreview
            ? yo`
              <div onclick=${onGoto} class="archive-history-item no-border" title="View local preview" href="broxme://library/${baseUrl}+preview${filePath}">
  ...
  function renderRow (c) {
    return yo`
      <div
        ...
        href="broxme://library/${baseUrl}+${c.version}${filePath}"
      >
