...
class BrowserMenu extends LitElement {
    ...
    return html`
      ...
      <div class="wrapper">
        ...
        <div class="section">
          ...
          <div class="menu-item" @click=${e => this.onOpenPage(e, 'broxme://watchlist')}>
            <i class="fa fa-eye"></i>
        ...
        <div class="section">
          ...
          <div class="menu-item" @click=${e => this.onOpenPage(e, 'https://github.com/broxme/brox/issues/new')}>
  ...
  async onCreateSite (e, template) {
    ...
    bg.shellMenus.createTab('broxme://library/' + url + '#setup')
    bg.shellMenus.close()
  }
