...
function drawTab (page) {
  ...
  if (page.isLoading() && page.getIntendedURL() !== pages.DEFAULT_URL) {
    ...
    } else if (page.getURL().startsWith('broxme:')) {
