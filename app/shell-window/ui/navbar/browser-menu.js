...
export class BrowserMenuNavbarBtn {
        ...
        <div class="toolbar-dropdown dropdown toolbar-dropdown-menu-dropdown">
          <div class="dropdown-items with-triangle">
            <div class="dropdown-wrapper">
              ...
              <div class="section">
                <div class="menu-item" onclick=${e => this.onOpenPage(e, 'broxme://library')}>
                  <i class="fa fa-book"></i>
                  <span class="label">Library</span>
                </div>

                <div class="menu-item" onclick=${e => this.onOpenPage(e, 'broxme://watchlist')}>
                  <i class="fa fa-eye"></i>
              ...
              <div class="section">
                ...
                <div class="menu-item" onclick=${e => this.onOpenPage(e, 'https://github.com/broxme/brox/issues/new')}>
  ...
  async onCreateSite (e, template) {
    ...
    pages.setActive(pages.create('broxme://library/' + archive.url + '#setup'))
  }
  ...
  async onShareFiles (e) {
    ...
    const archive = await DatArchive.create({
      ...
      description: `Files shared with Brox`,
      prompt: false
    })
    ...
    pages.setActive(pages.create('broxme://library/' + archive.url.slice('dat://'.length) + '#setup'))
  }
